...
const QueueSendChangedIpEmail = "queue:email:send-changed-ip"
const QueueSendIndividualConfirmEmail = "queue:email:send-individual-confirm-email"
...
const CacheJwt = "cache:jwt:%s:%s:%s:%d"

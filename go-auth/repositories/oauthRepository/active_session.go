...
func InsertActiveSessionLog(provider string, email string, companyName string, active bool, trusted bool, expiredAt *time.Time, deviceInfo *dto.DeviceDetectorInfo) *clickhouse.ActiveSession {

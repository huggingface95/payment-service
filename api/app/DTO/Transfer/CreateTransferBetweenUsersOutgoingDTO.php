...
class CreateTransferBetweenUsersOutgoingDTO extends CreateTransferBetweenUsersDTO
{
    ...
    {
        $args = array_merge($args, parent::getGeneralData(self::class, CreateTransferBetweenUsersIncomingDTO::class));
        ...
        $dto->sender_id = $args['sender_id'];
        $dto->sender_type = $args['sender_type'];
        $dto->recipient_bank_country_id = 1;

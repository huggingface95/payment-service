        ...
        $this->postGraphQL(
            [
                'query' => 'query BankCorrespondents($id: Mixed) {
                    bankCorrespondents (
                        filter: { column: HAS_BANK_CORRESPONDENT_CURRENCIES_FILTER_BY_CURRENCY_ID, value: $id }
                    ) {
                        data {
                            id
                            name
    ...
    public function testQueryBankCorrespondentsWithFilterByRegionId(): void
    {
        ...
        $this->postGraphQL(
            [
                'query' => 'query BankCorrespondents($id: Mixed) {
                    bankCorrespondents (
                        filter: { column: HAS_BANK_CORRESPONDENT_REGIONS_FILTER_BY_REGION_ID, value: $id }
                    ) {
                        data {
                            id
                            name

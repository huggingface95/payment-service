...
class CreateTransferIncomingTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('transfer_incomings', function (Blueprint $table) {
            $table->id();
            ...
            $table->enum('recipient_type', [class_basename(ApplicantIndividual::class), class_basename(ApplicantCompany::class)]);
            ...
            $table->string('sender_bank_swift', 255)->nullable();
            $table->unsignedInteger('sender_bank_country_id');
            $table->string('sender_name', 255);
            $table->unsignedInteger('sender_country_id');
            $table->string('sender_city', 255);
            $table->string('sender_address', 255);
            $table->string('sender_state', 255);
            $table->string('sender_zip', 255);
            ...
            $table->foreign('sender_bank_country_id')->references('id')->on('countries');
    ...
    {
        Schema::dropIfExists('transfer_incomings');
    }
}

...
class CreateTransferBetweenAccountsViewTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        DB::statement("
            CREATE VIEW transfer_between_accounts_view AS
                SELECT
    ...
    {
        DB::statement('DROP VIEW IF EXISTS transfer_between_accounts_view');
    }
}
